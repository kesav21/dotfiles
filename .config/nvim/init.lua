...
vim.cmd [[ autocmd! ]]
vim.cmd [[ autocmd Filetype typescript autocmd BufWritePre * undojoin | Neoformat ]]
vim.cmd [[ autocmd Filetype javascript autocmd BufWritePre * undojoin | Neoformat ]]
vim.cmd [[ autocmd Filetype python     autocmd BufWritePre * undojoin | Neoformat ]]
vim.cmd [[ autocmd Filetype sh         autocmd BufWritePre * undojoin | Neoformat ]]
vim.cmd [[ autocmd Filetype haskell    autocmd BufWritePre * undojoin | Neoformat ]]
vim.cmd [[ autocmd Filetype go         autocmd BufWritePre * undojoin | Neoformat ]]
vim.cmd [[ autocmd Filetype java       autocmd BufWritePre * undojoin | Neoformat ]]
vim.cmd [[ augroup END ]]
